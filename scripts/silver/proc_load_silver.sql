...
Actions performed:
  - Truncates Silver Silver tables
  - Inserts transformedd and cleanedd data from Bronze into Silver tables
...
BEGIN
	...
	BEGIN TRY
		...
		SELECT 
			...
			prd_nm,
			ISNULL(prd_cost , 0) AS prd_cost, -- Handling Null Value
		...
		SELECT
			...
			CASE WHEN TRIM(cntry) = 'DE'          THEN 'Germany'
					...
					ELSE TRIM(cntry)
			END AS cntry -- Normalize and Handl missing or blank country codes
